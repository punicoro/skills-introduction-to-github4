...
![screenshot showing an example profile readme](https://github.com/punicoro/skills-introduction-to-github4/blob/main/.github/images/example-profile-readme.png?raw=true)
...
2. リポジトリのヘッダーメニューにある **< > Code** タブに移動します。
   ...
   ![screenshot highlighting the code tab](https://github.com/punicoro/skills-introduction-to-github4/blob/main/.github/images/code-tab-highlight.png?raw=true)

3. **main** ブランチのドロップダウンをクリックします。

   <img width="300" alt="screenshot highlighting the branch selection" src="https://github.com/punicoro/skills-introduction-to-github4/blob/main/.github/images/branch-selection-dropdown.png?raw=true">
...
5. **Create branch: `my-first-branch` from main** というテキストをクリックして、ブランチを作成します。
   ...
   <img width="300" alt="screenshot highlighting the create branch prompt" src="https://github.com/punicoro/skills-introduction-to-github4/blob/main/.github/images/create-branch-prompt.png?raw=true">
